...
| `silverblue-nvidia-open-hardened` | Silverblue | Current proprietary NVIDIA driver with open source kernel modules (recommended for RTX 20xx and later)  | No            |
...
| `kinoite-nvidia-open-hardened` | Kinoite | Current proprietary NVIDIA driver with open source kernel modules (recommended for RTX 20xx and later) | No            |
...
| `sericea-nvidia-open-hardened` | Sericea | Current proprietary NVIDIA driver with open source kernel modules (recommended for RTX 20xx and later) | No            |
...
| `cosmic-nvidia-open-hardened` | COSMIC | Current proprietary NVIDIA driver with open source kernel modules (recommended for RTX 20xx and later) | No            |
...
| `securecore-nvidia-open-hardened`     | CoreOS | Current proprietary NVIDIA driver with open source kernel modules (recommended for RTX 20xx and later) | No          | No            |
...
| `securecore-zfs-nvidia-open-hardened` | CoreOS | Current proprietary NVIDIA driver with open source kernel modules (recommended for RTX 20xx and later) | Yes         | No            |
...
| `iot-nvidia-open-hardened`     | IoT  | Current proprietary NVIDIA driver with open source kernel modules (recommended for RTX 20xx and later) | No          | No            |
...
| `iot-zfs-nvidia-open-hardened` | IoT  | Current proprietary NVIDIA driver with open source kernel modules (recommended for RTX 20xx and later) | Yes         | No            |
